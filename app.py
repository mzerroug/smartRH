...
GOOGLE_CLIENT_ID = "184406483290-18l86kuv3791gso7ln0h0cc2l2v7sut3.apps.googleusercontent.com"
...
app.config['MONGO_URI']= 'mongodb+srv://admin:admin@cluster0.xvcp0f0.mongodb.net/ResumeAnalyse'
...
from Job_post import allowedExtension, job_post
...
# Set the secret key
app.config['SECRET_KEY'] = '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'
...
def callback():
    ...
    GOOGLE_CLIENT_ID = "184406483290-18l86kuv3791gso7ln0h0cc2l2v7sut3.apps.googleusercontent.com"  # Replace with your actual Google Client ID
